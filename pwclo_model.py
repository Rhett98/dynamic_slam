...
class pwclo_model(nn.Module):
    def __init__(self, args, batch_size, H_input, W_input, is_training, bn_decay=None):
        ...
        self.w_x = nn.Parameter(torch.tensor([0.0]), requires_grad=True)
        self.w_q = nn.Parameter(torch.tensor([-2.5]), requires_grad=True)
    ...
    def forward(self, input_xyz_f1, input_xyz_f2, T_gt, T_trans, T_trans_inv):
        ...
        # print("l3_points_f1:",l3_points_f1.shape)
        ###l3 cost_volume
        l3_cost_volume_w = self.flow_predictor0(l3_points_f1, None, l3_cost_volume)  ##E3和F3_f1融合
        # print("l3_cost_volume_w:", l3_cost_volume_w.shape)
        ...
        l2_points_warp_proj_f1 = torch.reshape(l2_points_warp_f1, [batch_size, self.out_H_list[2], self.out_W_list[2], -1])
        l2_points_proj_f2 = torch.reshape(l2_points_f2, [batch_size, self.out_H_list[2], self.out_W_list[2], -1])
        l2_cost_volume = self.cost_volume2(l2_xyz_warp_proj_f1, l2_xyz_proj_f2, l2_points_warp_proj_f1, l2_points_proj_f2)  ##RE
        ...
        # print("l2_points_warp_f1:",l2_points_warp_f1.shape)
        ...
        # print("l2_cost_volume_w:", l2_cost_volume_w.shape)
        ...
        l1_points_warp_proj_f1 = torch.reshape(l1_points_warp_f1, [batch_size, self.out_H_list[1], self.out_W_list[1], -1])
        l1_points_proj_f2 = torch.reshape(l1_points_f2, [batch_size, self.out_H_list[1], self.out_W_list[1], -1])
        ...
        l0_points_warp_proj_f1 = torch.reshape(l0_points_warp_f1, [batch_size, self.out_H_list[0], self.out_W_list[0], -1])
        l0_points_proj_f2 = torch.reshape(l0_points_f2, [batch_size, self.out_H_list[0], self.out_W_list[0], -1])
        ...
        # print("prepare time:",set_conv_start-start_train,"infer time:",time.time()-set_conv_start)
